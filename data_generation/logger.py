...
class Logger():
    ...
    def __init__(self, continue_logging, logging_directory, num_obj, offset):
        ...
        self.json_directory = os.path.join(self.base_directory, 'data', 'info')
    ...
    def save_images(self, iteration, color_image, depth_image, mode):
        ...
        im.save(os.path.join(self.color_images_directory, 'color_image_%06d.png' % (iteration + self.offset)))
    ...
    def save_json(self, iteration, shape_color_json):

        with open(os.path.join(self.json_directory, 'info_image_%06d.json' % (iteration + self.offset)), 'w') as f:
            f.write(shape_color_json)
